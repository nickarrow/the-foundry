...
Okay, creating an inline progress track vow: `iv-track-create:Finish the word wrapping implementation|The Starforged (NickArrow)/Progress/Finish the word wrapping implementation.md` Now, I'll throw in an oracle roll,  `iv-oracle:Likely|5|Yes|move.oracle_rollable:starforged/fate/ask_the_oracle.likely`  That looks nice.  Now that I have created a track, I can try advancing it and see how it looks with some word wrapping, good/bad?  `iv-track-advance:Finish the word wrapping implementation|The Starforged (NickArrow)/Progress/Finish the word wrapping implementation.md|0|24|troublesome|2` I am not sure I love that, another example:  `iv-progress:Finish the word wrapping implementation|6|7|10|The Starforged (NickArrow)/Progress/Finish the word wrapping implementation.md`    